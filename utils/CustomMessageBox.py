...
class MessageBox(QMessageBox):
    def __init__(self, *args, title='提示', count=1, time=1000, auto=False,mod=0, **kwargs):
        ...
        if mod == 0:
            self.setIconPixmap(QPixmap(":/img/icon/swap1.png"))
        else:
            self.setIconPixmap(QPixmap(":/img/icon/book1.png"))
